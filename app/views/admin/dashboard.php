                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mt-5">
                                            <div class="card-text">
                                                ...
                                                <p class="card-text">Jumlah Transaksi: 
                                                <span id="transaksiCount">
                                                        <?php
                                                        // Include the database connection file
                                                        include_once '/xampp/htdocs/project-rental-mobil/app/config/database.php';

                                                        // Fetch car count from the database (Assuming your query is correct)
                                                        $sql = "SELECT COUNT(*) AS count FROM viewriwayattransaksi";
                                                        $query = mysqli_query($db, $sql);
                                                        $result = mysqli_fetch_assoc($query);
                                                        $transaksiCount = $result['count'];
                                                ...
                                                <a href="./data-transaksi.php" class="btn btn-primary">Lihat</a>
                                            </div>
                                        </div>
